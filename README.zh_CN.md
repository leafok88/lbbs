...
![欢迎界面](misc/images/ssh_welcome.jpg "欢迎访问LBBS")
![主菜单](misc/images/telnet_menu.jpg "主选单")
![版块视图](misc/images/telnet_section.jpg "文章列表")
![文章阅读器](misc/images/telnet_article_reader.jpg "文章阅读")

## 系统需求

1. GNU C 编译器
2. PHP (版本 8.2 或更高)
3. MySQL数据库 (版本 8.4 或更高)
